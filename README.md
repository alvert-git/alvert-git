## Quick Profile: Albert Belbase

### Full-Stack Developer | Data & AI Enthusiast

I build **robust web applications** using the **MERN/Next.js stack** and drive insights through **data analysis** and **Machine Learning**.
